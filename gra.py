...
class gra():
    ...
    def Przeciwnicy(self):
        ...
        for i in range(3):
            for y in range(7):
                self.ekran.blit(self.obraz_przeciwnicy, (self.przeciwnicy_x, self.przeciwnicy_y))
                self.przeciwnicy_x += 100
            self.przeciwnicy_x = 120
            self.przeciwnicy_y += 100
        pygame.display.update()
...
if __name__=="__main__":
    ...
    spaceinvaders=gra()
    # uruchamiamy metodę przeciwnicy
    spaceinvaders.Przeciwnicy()
